export const overlayStyles = `
  ...
  .magnifier { position:fixed;display:block;width:136px;padding:7px;box-sizing:border-box;border:1px solid #475569;border-radius:9px;background:#0f172a;box-shadow:0 8px 26px rgba(0,0,0,.4);pointer-events:none;z-index:2147483647;will-change:transform; }
